...
// プレイヤースプライト（パスは必要に応じて変更）
const PLAYER_SPRITES = {
  RUN1: "/Wedding-Run/public/assets/images/chara_1.png",
  RUN2: "/Wedding-Run/public/assets/images/chara_2.png",
  DIE: "/Wedding-Run/public/assets/images/chara_3.png",
} as const;
